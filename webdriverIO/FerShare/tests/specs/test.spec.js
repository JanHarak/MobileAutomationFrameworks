const mainScreen = require("../screens/MainScreenObject");

describe("FerShare Test suite", () => {
  ...
  it("Calculate fuel consume with ScreenObjectModel", async () => {
    ...
    await mainScreen.otherCostsInput.setValue(720);
  ...
  afterEach(async () => {
    ...
    await browser.terminateApp("com.FerShare.fershare");
  });
});
